...
export const SITE_ITEM_RESPONSE = {
  ...
  owner: "dbouwman_dc",
  created: 1570740645000,
  isOrgItem: true,
  modified: 1581379042000,
  guid: null,
  name: null,
  title: "dave-public",
  ...
  culture: "en-us",
  properties: {
    contentGroupId: "b2ee4e0403c14b9e8c61727a4d24b9b9",
    createdFrom: "defaultInitiativeSiteTemplate",
    schemaVersion: 1.3,
    hasSeenGlobalNav: true,
    followersGroupId: "4d2e989bd62f4b079f8cf76feb57018b",
...
export const SITE_DATA_RESPONSE = {
  ...
  values: {
              ...
              cards: [
                {
                  component: {
                    ...
                    settings: {
                      ...
                      cropSrc: "hub-image-card-crop-iotoe4w50.png",
                      isUrl: false,
                      isFile: true,
                      state: "valid",
                      position: {
              ...
              cards: [
                {
                  component: {
                    ...
                    settings: {
                      src: "",
                      fileSrc: "dave-in-the-cave.png",
                      cropSrc: "hub-image-card-crop-i3e7knwx9.png",
                      alt: "",
                      caption: "",
                      captionAlign: "center",
                      hyperlink: "",
    ...
    defaultHostname: "dave-public-dc.hubqa.arcgis.com",
    subdomain: "dave-public",
    collaborationGroupId: "30fc8519368e4ae79f2f2060eca799b1",
    updatedAt: "2020-02-11T18:57:08.264Z",
    updatedBy: "dbouwman_dc",
    capabilities: [
      "geohash",
      "api_explorer",
      "pages",
