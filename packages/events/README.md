...
[npm-img]: https://img.shields.io/npm/v/@esri/hub-events.svg?style=flat-square
[npm-url]: https://www.npmjs.com/package/@esri/hub-events
...
[gzip-image]: https://img.badgesize.io/https://unpkg.com/@esri/hub-events/dist/umd/events.umd.min.js?compression=gzip
...
```bash
npm install @esri/hub-events
```
```js
import { getEventServiceUrl } from "@esri/hub-events";

 // pass in an organization id
getEventServiceUrl("abc123")
    .then(eventsUrl => {
      // https://services.arcgis.com/abc123/arcgis/rest/services/Hub%20Events%20(public)/FeatureServer/0
    });
```

## [API Reference](https://esri.github.io/hub.js/api/events/)
