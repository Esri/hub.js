...
describe("ensureUniqueEntitySlug:", () => {
  ...
  beforeEach(() => {
    ...
    jest
      .spyOn(Slugs, "getUniqueSlug")
      .mockReturnValue(Promise.resolve("org|my-slug-unique"));
    jest
      .spyOn(Slugs, "setSlugKeyword")
      .mockImplementation((keywords: string[], slug: string) => [
        ...keywords,
        `slug|${slug}`,
      ]);
    jest
      .spyOn(InternalSlugs, "truncateSlug")
      .mockImplementation(
