...
describe("serializeCatalogScope", () => {
  ...
  beforeEach(() => {
    ...
    jest.spyOn(upgradeCatalogSchemaModule, "upgradeCatalogSchema");
    jest.spyOn(expandPortalQueryModule, "expandPortalQuery");
    jest.spyOn(serializeQueryForPortalModule, "serializeQueryForPortal");
  });
