...
describe("serializeCatalogScope", () => {
  ...
  beforeEach(() => {
    ...
    spyOn(upgradeCatalogSchemaModule, "upgradeCatalogSchema").and.callThrough();
    spyOn(expandPortalQueryModule, "expandPortalQuery").and.callThrough();
    spyOn(
      serializeQueryForPortalModule,
