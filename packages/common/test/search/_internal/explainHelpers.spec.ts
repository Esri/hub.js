...
// Mock the portal module to make its named exports spyable in ESM
...
describe("explainQuery helpers:", () => {
  ...
  describe("explainDatePredicate:", () => {
    it("throws because it is not implemented", () => {
      ...
      expect(() =>
        explainDatePredicate(predicate, result, {} as IRequestOptions)
  ...
  describe("explainPropPredicate:", () => {
    it("throws because it is not implemented", () => {
      ...
      expect(() =>
        explainPropPredicate(predicate, result, {} as IRequestOptions)
      ).toThrow("Not implemented");
    });
  });
    ...
    describe("handling groups:", () => {
      it("fetches item groups and falls through to array in array checks", async () => {
        const getGroupsSpy = vi
          .spyOn(PortalModule as any, "getItemGroups")
          .mockResolvedValue(ITEM_GROUPS_RESPONSE);
        const predicate: IPredicate = {
          group: {
            any: ["g01", "ga02"],
          },
