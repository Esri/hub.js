...
describe("hubSearchItems Module |", () => {
  ...
  describe("Main Search Functions |", () => {
    describe("ogcApiRequest", () => {
      const requestUrl = "https://hub.arcgis.com/api/search/v1/collections/all/items";
      ...
      it("appends the query parameters onto the request url", async () => {
        ...
        await ogcApiRequest(requestUrl, queryParams as unknown as IOgcItemQueryParams, options);
      });
