...
import type { IFeatureServiceDefinition } from "../../src/rest/types";
...
export const MAP_SERVICE_GUID = "A1295DEF67814571B99EDDEA65748147";
export const MAP_SERVICE_URL =
  "https://services.arcgis.com/:orgId/arcgis/rest/services/:serviceName/MapServer";
export const MAP_SERVICE_ITEM: IItem = {
  id: MAP_SERVICE_GUID,
  access: "public",
  owner: "dev_pre_hub_admin",
  created: 1652819949000,
...
export const MAP_SERVICE_DEFINITION = {
  capabilities: "Query",
} as IFeatureServiceDefinition;
