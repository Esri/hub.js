...
describe("templates: computeLinks", () => {
  ...
  beforeEach(async () => {
    ...
    jest
      .spyOn(getItemHomeUrlModule, "getItemHomeUrl")
      .mockReturnValue("/some-item-home-url");
    jest
      .spyOn(getItemThumbnailUrlModule, "getItemThumbnailUrl")
      .mockReturnValue("/some-thumbnail-url");
  });
