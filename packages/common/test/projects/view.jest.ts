...
describe("project view module:", () => {
  ...
  beforeEach(() => {
    getShortenedCategoriesSpy = jest
  ...
  describe("projectToCardModel:", () => {
    ...
    beforeEach(() => {
      getCardModelUrlFromEntitySpy = jest
        .spyOn(titleUrlModule, "getCardModelUrlFromEntity")
        .mockReturnValue("https://mock-title-url.com");
    });
  ...
  describe("projectResultToCardModel", () => {
    ...
    beforeEach(() => {
      getCardModelUrlFromResultSpy = jest
        .spyOn(titleUrlModule, "getCardModelUrlFromResult")
        .mockReturnValue("https://mock-title-url.com");
    });
