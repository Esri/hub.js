import { addOrInviteUsersToTeams } from "../../src/teams/add-or-invite-users-to-teams";
import { MOCK_AUTH } from "./fixtures";
import * as addOrInviteUsersToTeamModule from "../../src/teams/add-or-invite-users-to-team";
