...
describe("EventGalleryCardUiSchema", () => {
  describe("buildUiSchema", () => {
    it("should resolve a IUiSchema for the event gallery card editor", async () => {
      ...
      const getTagItemsSpy = jest
        .spyOn(getTagItemsModule, "getTagItems")
        .mockReturnValue(Promise.resolve(comboboxItems));
      const fetchCategoriesUiSchemaElementSpy = jest
        .spyOn(
          fetchCategoriesUiSchemaElementModule,
          "fetchCategoriesUiSchemaElement"
        )
        .mockReturnValue(Promise.resolve(categoriesUiSchemaElement));
      const getWellKnownCatalogSpy = jest
