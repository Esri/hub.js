 ...
 *   2. hubId
 *   3. id
 * @param content The ArcGIS [item type](https://developers.arcgis.com/rest/users-groups-and-items/items-and-item-types.htm).
 * @returns the category of a given item type.
 */
export function getContentIdentifier(
  ...
  // site data instead. Becausue this one is the original one that was used
