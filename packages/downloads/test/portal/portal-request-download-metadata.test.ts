        ...
        expect(searchItemsSpy.calls.argsFor(0)).toEqual([
          {
            ...
            num: 1,
            q:
              '(typekeywords:"exportItem:abcdef0123456789abcdef0123456789" AND typekeywords:"exportLayer:null") AND ( (type:CSV AND typekeywords:"spatialRefId:4326"))',
            sortField: "modified",
            sortOrder: "DESC"
          }
        ]);
        ...
        expect(searchItemsSpy.calls.argsFor(0)).toEqual([
          {
            ...
            num: 1,
            q:
              '(typekeywords:"exportItem:abcdef0123456789abcdef0123456789" AND typekeywords:"exportLayer:00") AND ( (type:CSV AND typekeywords:"spatialRefId:4326"))',
            sortField: "modified",
            sortOrder: "DESC"
          }
        ]);
        ...
        expect(searchItemsSpy.calls.argsFor(0)).toEqual([
          {
            ...
            num: 1,
            q:
              '(typekeywords:"exportItem:abcdef0123456789abcdef0123456789" AND typekeywords:"exportLayer:null") AND ( (type:"CSV Collection" AND typekeywords:"spatialRefId:4326"))',
            sortField: "modified",
            sortOrder: "DESC"
          }
        ]);
        ...
        expect(searchItemsSpy.calls.argsFor(0)).toEqual([
          {
            ...
            num: 1,
            q:
              '(typekeywords:"exportItem:abcdef0123456789abcdef0123456789" AND typekeywords:"exportLayer:null") AND ( (type:"KML Collection" AND typekeywords:"spatialRefId:4326"))',
            sortField: "modified",
            sortOrder: "DESC"
          }
        ]);
        ...
        expect(searchItemsSpy.calls.argsFor(0)).toEqual([
          {
            ...
            num: 1,
            q:
              '(typekeywords:"exportItem:abcdef0123456789abcdef0123456789" AND typekeywords:"exportLayer:null") AND ( (type:Shapefile AND typekeywords:"spatialRefId:4326"))',
            sortField: "modified",
            sortOrder: "DESC"
          }
        ]);
