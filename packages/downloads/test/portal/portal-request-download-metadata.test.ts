        ...
        expect(searchItemsSpy.calls.argsFor(0)).toEqual([
          {
            ...
            num: 1,
            q:
              'typekeywords:exportItem:abcdef0123456789abcdef0123456789 AND typekeywords:exportLayer:null AND (type:CSV)',
            sortField: "modified",
            sortOrder: "DESC"
          }
        ]);
        ...
        expect(searchItemsSpy.calls.argsFor(0)).toEqual([
          {
            ...
            num: 1,
            q:
              'typekeywords:exportItem:abcdef0123456789abcdef0123456789 AND typekeywords:exportLayer:00 AND (type:CSV)',
            sortField: "modified",
            sortOrder: "DESC"
          }
        ]);
        ...
        expect(searchItemsSpy.calls.argsFor(0)).toEqual([
          {
            ...
            num: 1,
            q:
              'typekeywords:exportItem:abcdef0123456789abcdef0123456789 AND typekeywords:exportLayer:null AND (type:"CSV Collection")',
            sortField: "modified",
            sortOrder: "DESC"
          }
        ]);
        ...
        expect(searchItemsSpy.calls.argsFor(0)).toEqual([
          {
            ...
            num: 1,
            q:
              'typekeywords:exportItem:abcdef0123456789abcdef0123456789 AND typekeywords:exportLayer:null AND (type:"KML Collection")',
            sortField: "modified",
            sortOrder: "DESC"
          }
        ]);
        ...
        expect(searchItemsSpy.calls.argsFor(0)).toEqual([
          {
            ...
            num: 1,
            q:
              'typekeywords:exportItem:abcdef0123456789abcdef0123456789 AND typekeywords:exportLayer:null AND (type:Shapefile)',
            sortField: "modified",
            sortOrder: "DESC"
          }
        ]);
    ...
    it("with spatialRefId", async done => {
      try {
        ...
        expect((portal.searchItems as any).calls.first().args).toEqual([
          {
            q:
              'typekeywords:exportItem:abcdef0123456789abcdef0123456789 AND typekeywords:exportLayer:null AND (type:CSV) AND spatialRefId:4326',
            num: 1,
            sortField: "modified",
            sortOrder: "DESC",
            authentication
