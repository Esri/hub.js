    ...
    tseslint.configs.recommended,
    {
        ...
        rules: {
            ...
            "no-restricted-syntax": ["error", {
                selector: "ExportNamedDeclaration[source] :not([parent.id.name=\"index.ts\"])", // Named exports with a source (re-exports)
                ...
                message: "Enums are not allowed. Consider using separate const and type. E.g. const FRUIT = { APPLE: 'apple', BANANA: 'banana' } as const; type Fruit = typeof FRUIT[keyof typeof FRUIT];",
            }, {
