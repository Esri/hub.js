...
export const initiativeVersionOneDotOne: IInitiativeModel = {
  item: {
    ...
    url: "https://hubqa.arcgis.com/admin/initiatives/bf5cc1f0e18f45aa91ecaa6ba004ba7d",
    access: "shared",
  ...
  data: {
    ...
    values: {
      ...
      optionalData: {
        url: "https://servicesqa.arcgis.com/97KLIFOSt5CxbiRI/arcgis/rest/services/survey123_7d7a9fabcb0c44bcaf1d6473cd088a07/FeatureServer/1",
        layerId: 1,
    ...
    assets: [
      {
        id: "bannerImage",
        url: "https://dc.mapsqa.arcgis.com/sharing/rest/content/items/bf5cc1f0e18f45aa91ecaa6ba004ba7d/resources/detail-image.jpg",
        properties: {
          type: "resource",
      ...
      {
        id: "iconDark",
        url: "https://dc.mapsqa.arcgis.com/sharing/rest/content/items/bf5cc1f0e18f45aa91ecaa6ba004ba7d/resources/icon-dark.png",
        properties: {
          type: "resource",
      ...
      {
        id: "iconLight",
        url: "https://dc.mapsqa.arcgis.com/sharing/rest/content/items/bf5cc1f0e18f45aa91ecaa6ba004ba7d/resources/icon-light.png",
        properties: {
          type: "resource",
