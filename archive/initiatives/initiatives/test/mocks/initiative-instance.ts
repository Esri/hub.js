...
export const InitiativeInstance: IInitiativeModel = {
  item: {
    ...
    url: "https://hubqa.arcgis.com/admin/initiatives/6c6a543a74674939a9352a3454e9efd3",
    proxyFilter: null,
    access: "shared",
    size: -1,
    appCategories: [],
  ...
  data: {
    assets: [
      {
        id: "bannerImage",
        url: "https://dc.mapsqa.arcgis.com/sharing/rest/content/items/b746772712ef4c68a53d0e268e3c8f49/resources/detail-image.jpg",
        properties: {
          type: "resource",
      ...
      {
        id: "iconDark",
        url: "https://dc.mapsqa.arcgis.com/sharing/rest/content/items/b746772712ef4c68a53d0e268e3c8f49/resources/icon-dark.png",
        properties: {
          type: "resource",
      ...
      {
        id: "iconLight",
        url: "https://dc.mapsqa.arcgis.com/sharing/rest/content/items/b746772712ef4c68a53d0e268e3c8f49/resources/icon-light.png",
        properties: {
          type: "resource",
    ...
    indicators: [
      {
        ...
        source: {
          type: "FeatureLayer",
          url: "https://servicesqa.arcgis.com/97KLIFOSt5CxbiRI/arcgis/rest/services/Collisions_Indicator_(Small)_for_Development/FeatureServer/0",
          layerId: 0,
