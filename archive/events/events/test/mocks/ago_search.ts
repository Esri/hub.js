...
const adminItem: IItem = {
  ...
  url: "https://services.arcgis.com/uCXeTVveQzP4IIcx/arcgis/rest/services/Hub Events/FeatureServer",
  proxyFilter: null,
  access: "shared",
  size: -1,
  appCategories: [],
...
const orgItem: IItem = {
  ...
  url: "https://services.arcgis.com/uCXeTVveQzP4IIcx/arcgis/rest/services/Hub Events (org)/FeatureServer",
  proxyFilter: null,
  access: "org",
  size: -1,
  appCategories: [],
...
const publicItem: IItem = {
  ...
  url: "https://services.arcgis.com/uCXeTVveQzP4IIcx/arcgis/rest/services/Hub Events (public)/FeatureServer",
  proxyFilter: null,
  access: "public",
  size: -1,
  appCategories: [],
